...
// Sides
  StylePtr<Layers<
    ...
    // On-Demand Battery Level for use with an active Color When Off
    AlphaL<TransitionEffectL<TrConcat<TrFade<300>,Black,TrExtend<2000,TrSmoothFade<500>>,Layers<Black,AlphaL<Mix<BatteryLevel,Red,Green>,SmoothStep<Scale<BatteryLevel,Int<0>,Int<35000>>,Int<-1>>>>,TrFade<1000>,Black,TrFade<300>>,EFFECT_BATTERY_LEVEL>,Ifon<Int<0>,Int<32768>>>
  >>(),
"2nd\nsister"},
...
// Blade 2
  StylePtr<Layers<
    EffectSequence<EFFECT_USER4, // Used to toggle base color on-off.
      ...
      // from the base blade color down to, but not including, the InOutTrL.
Layers< // ------------------- on press
  Mix<SwingSpeed<300>,AudioFlicker<RotateColorsX<Variation,Red>,RotateColorsX<Variation,Rgb<128,0,0>>>,StripesX<Int<1500>,Scale<SlowNoise<Int<2500>>,Int<-3000>,Int<-5000>>,RotateColorsX<Variation,Red>,RotateColorsX<Variation,Rgb<80,0,0>>,RotateColorsX<Variation,Rgb<255,50,50>>,RotateColorsX<Variation,Rgb<20,0,0>>,RotateColorsX<Variation,Red>>>,
  BC_effects_Red_Alt,
  TransitionEffectL<TrConcat<TrInstant,HumpFlickerL<White,50>,TrFade<1000>>,EFFECT_USER4> // pseudo EFFECT_IGNITION
>, // -------------------
    Black>, // Starts Here
...
Layers< // ------------------- on press
  ...
  AlphaL<LightCyan,SmoothStep<Int<2000>,Int<-6000>>>,
  TransitionEffectL<TrConcat<TrInstant,HumpFlickerL<White,40>,TrFade<1200>>,EFFECT_IGNITION>,
  TransitionEffectL<TrConcat<TrFadeX<WavLen<EFFECT_RETRACTION>>,Stripes<3000,3500,Blue,RandomPerLEDFlicker<Mix<Int<7710>,Black,Blue>,Black>,BrownNoiseFlicker<Blue,Mix<Int<3855>,Black,Blue>,200>,RandomPerLEDFlicker<Mix<Int<3137>,Black,Blue>,Mix<Int<3855>,Black,Blue>>>,TrInstant>,EFFECT_USER4>,
  BC_effects_1_Alt
>, // -------------------
    Black>, // Starts Here
    EffectSequence<EFFECT_USER4,TransitionEffectL<TrConcat<TrInstant,Black,TrWipe<500>>,EFFECT_USER4>,TransitionEffectL<TrConcat<TrInstant, // toggled pseudo extension wipe 
...
// Sides
  StylePtr<Layers<
    Stripes<1000,-300,Blue,Rgb<0,0,128>,Black>,
    TransitionEffectL<TrConcat<TrFadeX<Percentage<WavLen<EFFECT_FORCE>,20>>,Pulsing<Rgb<0,0,90>,Blue,400>,TrDelayX<Percentage<WavLen<>,80>>,Rgb<80,80,255>,TrFade<800>>,EFFECT_FORCE>,
    TransitionEffectL<TrConcat<TrInstant,Blinking<White,Orange,20,500>,TrFade<400>>,EFFECT_CLASH>,
    TransitionEffectL<TrConcat<TrInstant,Blinking<White,Orange,20,500>,TrFade<400>>,EFFECT_BLAST>,
    LockupTrL<Blinking<White,Strobe<Black,Red,15,30>,60,500>,TrConcat<TrInstant,Blinking<White,Strobe<BrownNoiseFlicker<White,Black,500>,Black,15,30>,60,500>,TrFade<500>>,TrConcat<TrInstant,Blinking<White,Strobe<BrownNoiseFlicker<White,Black,500>,Black,15,30>,60,500>,TrFade<500>>,SaberBase::LOCKUP_NORMAL>,
    LockupTrL<RandomFlicker<Strobe<White,Rgb<60,0,255>,50,10>,BrownNoiseFlicker<Rgb<60,0,255>,Black,500>>,TrConcat<TrInstant,GreenYellow,TrDelay<25>>,TrConcat<TrInstant,GreenYellow,TrDelay<25>,BrownNoiseFlickerL<White,Int<50>>,TrFade<500>>,SaberBase::LOCKUP_LIGHTNING_BLOCK>,
    LockupTrL<AudioFlicker<BrownNoiseFlicker<Strobe<Black,OrangeRed,20,25>,Red,200>,White>,TrConcat<TrInstant,White,TrFade<400>>,TrColorCycle<1500,-2000>,SaberBase::LOCKUP_DRAG>,
    LockupTrL<StaticFire<Mix<TwistAngle<>,OrangeRed,DarkOrange>,Mix<TwistAngle<>,OrangeRed,Orange>,0,3,5,3000,10>,TrConcat<TrWipeIn<100>,BrownNoiseFlicker<Red,Black,300>,TrExtend<1000,TrFade<3000>>,Mix<TwistAngle<>,Red,Orange>,TrFade<3000>>,TrWipe<200>,SaberBase::LOCKUP_MELT>,
    InOutTrL<TrConcat<TrInstant,HumpFlicker<White,Black,50>,TrSmoothFade<1000>>,TrConcat<TrFadeX<WavLen<EFFECT_RETRACTION>>,HumpFlicker<White,Black,50>,TrInstant>,TransitionLoop<TransitionLoop<Black,TrConcat<TrCenterWipe<1000>,Blue,TrCenterWipeIn<1000>>>,TrConcat<TrJoin<TrDelay<2000>,TrCenterWipe<2000>>,TransitionLoop<Black,TrConcat<TrCenterWipeIn<1000>,Blue,TrCenterWipe<1000>>>,TrJoin<TrDelay<2000>,TrCenterWipeIn<1000>>,TransitionLoop<Black,TrConcat<TrCenterWipeIn<1000>,Blue,TrCenterWipe<2000>>>,TrJoin<TrDelay<4000>,TrCenterWipeIn<2000>>>>>,
    // On-Demand Battery Level for use with an active Color When Off
    AlphaL<TransitionEffectL<TrConcat<TrFade<300>,Black,TrExtend<2000,TrSmoothFade<500>>,Layers<Black,AlphaL<Mix<BatteryLevel,Red,Green>,SmoothStep<Scale<BatteryLevel,Int<0>,Int<35000>>,Int<-1>>>>,TrFade<1000>,Black,TrFade<300>>,EFFECT_BATTERY_LEVEL>,Ifon<Int<0>,Int<32768>>>
  >>(),
"liquid\nstatic"},
...
// Crystal Chamber
 StylePtr<Layers<
    StyleFire<Green,Rgb<100,255,100>,0,2,FireConfig<0,1500,0>,FireConfig<3000,0,0>,FireConfig<0,5000,10>,FireConfig<0,0,5>>,
    TransitionEffectL<TrConcat<TrInstant,White,TrFade<200>>,EFFECT_IGNITION>,
    TransitionEffectL<TrConcat<TrInstant,White,TrFade<200>>,EFFECT_BLAST>,
    LockupL<AudioFlicker<OnSpark<StyleFire<Green,Rgb<100,255,100>,0,2,FireConfig<0,1500,0>,FireConfig<3000,0,0>,FireConfig<0,5000,10>,FireConfig<0,0,5>>>,White>>,
    TransitionEffectL<TrConcat<TrInstant,White,TrDelay<40>>,EFFECT_CLASH>,
    LockupTrL<StaticFire<Mix<TwistAngle<>,OrangeRed,DarkOrange>,Mix<TwistAngle<>,OrangeRed,Orange>,0,3,5,3000,10>,TrConcat<TrWipeIn<100>,BrownNoiseFlicker<Red,Black,300>,TrExtend<1000,TrFade<3000>>,Mix<TwistAngle<>,Red,Orange>,TrFade<3000>>,TrWipe<200>,SaberBase::LOCKUP_MELT>,
    InOutTrL<TrFade<300>,TrFade<500>,Pulsing<Layers<
...
// Sides
  StylePtr<Layers<
    ...
    LockupTrL<AudioFlicker<BrownNoiseFlicker<Strobe<Black,OrangeRed,20,25>,Red,200>,White>,TrConcat<TrInstant,White,TrFade<400>>,TrColorCycle<1500,-2000>,SaberBase::LOCKUP_DRAG>,
    LockupTrL<StaticFire<Mix<TwistAngle<>,OrangeRed,DarkOrange>,Mix<TwistAngle<>,OrangeRed,Orange>,0,3,5,3000,10>,TrConcat<TrWipeIn<100>,BrownNoiseFlicker<Red,Black,300>,TrExtend<1000,TrFade<3000>>,Mix<TwistAngle<>,Red,Orange>,TrFade<3000>>,TrWipe<200>,SaberBase::LOCKUP_MELT>,
    InOutTrL<TrConcat<TrInstant,HumpFlicker<White,Black,50>,TrSmoothFade<1000>>,TrConcat<TrFadeX<WavLen<EFFECT_RETRACTION>>,HumpFlicker<White,Black,50>,TrInstant>,TransitionLoop<TransitionLoop<Black,TrConcat<TrCenterWipe<1000>,
...
BladeConfig blades[] = {
{ 0,
  WS281XBladePtr<123, bladePin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3> >(),   // Main Blade 1 and PCB
  WS281XBladePtr<123, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin4, bladePowerPin5> >(),  // Main Blade 2 and PCB
