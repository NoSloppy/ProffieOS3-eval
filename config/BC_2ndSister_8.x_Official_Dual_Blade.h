// BC_2ndSister_8.x_Official_Dual_Blade.h
...
// A System Menu is available to edit presets, colors settings. To use this menu system instead, use the following define:
...
//  aa_Greyscale/Omen_Greyscale                                 // custom Greyscale style by KidsTryThisAtHome BC mod
07. aa_Greyscale/BinaryDark_Greyscale                           // Same as Omen, but use RotateColorsX
// aa_Greyscale/BinaryLight_Greyscale                          // Same as Omen, but use RotateColorsX
// aa_Greyscale/AwakenV2_Greyscale                              // custom Greyscale stlye by KidsTryThisAtHome BC mod 
08. aa_HarrySolo/DESTABILIZE                                    // custom Cyan->Purple fire w/ BC_effects_1
09. aa_JayDalorian/Decimate                                     // Purple Fire w/ BC_effects_Red
10. aa_Juansith/HATE                                            // rotatable Red
...
{ "aa_Blueforce/CyberAssassin2;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
{ "aa_Blueforce/TempleGuardian;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
// { "aa_Greyscale/Omen_Greyscale;ProffieOS_V2_Voicepack_Stranger/ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
{ "aa_Greyscale/BinaryDark_Greyscale;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
// { "aa_Greyscale/BinaryLight_Greyscale;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
// { "aa_Greyscale/AwakenV2_Greyscale;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
{ "aa_HarrySolo/DESTABILIZE;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
{ "aa_JayDalorian/Decimate;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
{ "aa_Juansith/HATE;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "",
*/

Preset SecondSister[] = {

// Preset 0
{ "a_INQUISITOR/2ndSistr;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "a_INQUISITOR/tracks/Enter_The_Inquisitor.wav",
 // Blade 1
  StylePtr<Layers<
...
// Preset 1
{ "a_INQUISITOR/RevaUltimate;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "a_INQUISITOR/tracks/Inquisitor_Theme.wav",
 // Blade 1
  StylePtr<Layers<
...
// Preset 2
{ "a_INQUISITOR/GrandHunter;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "a_INQUISITOR/GrandHunter/tracks/track1.wav",
 // Blade 1
  StylePtr<Layers<
    Mix<SwingSpeed<300>,StaticFire<BrownNoiseFlicker<RotateColorsX<Variation,Red>,RandomPerLEDFlicker<RotateColorsX<Variation,Rgb<25,0,0>>,RotateColorsX<Variation,Rgb<60,0,0>>>,300>,RotateColorsX<Variation,Rgb<80,0,0>>,0,6,10,1000,2>,AudioFlicker<RotateColorsX<Variation,Red>,RotateColorsX<Variation,Rgb<128,0,0>>>>,
    BC_effects_Red,
...
// Preset 3
{ "a_INQUISITOR/9thSistr;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "a_INQUISITOR/tracks/Inquisitor_Theme.wav",
// Blade 1
  StylePtr<Layers<
...
// Preset 4 
{ "aa_Blueforce/LiquidStatic;ProffieOS_V2_Voicepack_Stranger/ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "tracks/track1.wav",
// Blade 1
  StylePtr<Layers<
...
BladeConfig blades[] = {
{ NO_BLADE,
  WS281XBladePtr<0, bladePin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3> >(),   // Main Blade 1
  WS281XBladePtr<144, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin4, bladePowerPin5> >(),  // Main Blade 2
...
CONFIGARRAY(SecondSister),
"00_NoBladeSave"}, 


{ 0,
  WS281XBladePtr<144, bladePin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3> >(),   // Main Blade 1
  WS281XBladePtr<144, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin4, bladePowerPin5> >(),  // Main Blade 2
  WS281XBladePtr<4, blade3Pin, Color8::GRB, PowerPINS<bladePowerPin6> >(),                    // Crystals
  WS281XBladePtr<5, blade4Pin, Color8::GRB, PowerPINS<bladePowerPin1> >(),                    // Sides
CONFIGARRAY(SecondSister),
