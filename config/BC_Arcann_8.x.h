...
//#define REAL_TIME_BLADE_ID_POWER_PINS 2, 3
                ...
                #define NO_BLADE_ID_RANGE 600000,99999999
...
#define ORIENTATION_ROTATION 0,200,0
...
using ChamberTop = Layers<
    RandomFlicker<Rgb<90,65,0>,Rgb<255,155,0>>,
    BlastFadeoutL<Red,400>,
    LockupL<BlinkingX<BlinkingX<Rgb<180,130,0>,Black,Scale<RandomF,Int<50>,Int<100>>,Int<500>>,White,Scale<RandomF,Int<10>,Int<50>>,Int<700>>,AudioFlicker<Rgb<255,155,0>,Blue>,Int<32768>,Int<32768>,Int<32768>>,
    SimpleClashL<White,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
    LockupTrL<Pulsing<Red,Rgb<255,155,0>,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
    InOutTrL<TrConcat<TrInstant,White,TrFade<200>,Rgb<255,155,0>,TrFade<1500>>,TrFade<1000>,Pulsing<Black,RandomFlicker<Mix<Int<29000>,Rgb<255,155,0>,Black>,Mix<Int<31000>,Rgb<255,155,0>,Black>>,3500>>>;
using ChamberBottom = Layers<
    RandomFlicker<Rgb<90,65,0>,Yellow>,
    BlastFadeoutL<Red,400>,
    LockupL<BlinkingX<BlinkingX<Rgb<180,130,0>,Black,Scale<RandomF,Int<50>,Int<100>>,Int<500>>,White,Scale<RandomF,Int<10>,Int<50>>,Int<700>>,AudioFlicker<Yellow,Blue>,Int<32768>,Int<32768>,Int<32768>>,
    SimpleClashL<White,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
    LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
    InOutTrL<TrConcat<TrInstant,White,TrFade<200>,Yellow,TrFade<1500>>,TrFade<1000>,Pulsing<RandomFlicker<Mix<Int<29000>,Yellow,Black>,Mix<Int<31000>,Yellow,Black>>,Black,3000>>>;

/* ---- Presets list ---- /*

a_ARCANN/Arcann_KSxK
a_ARCANN/Thexan_KSxK
aa_BK/The_Wicked
a_ARCANN/Arcann_EHA
a_ARCANN/Dark_Knights_KotFE
a_ARCANN/Eternal_Prince
...
// //   // TransitionEffectL<TrDoEffectAlways<TrInstant,EFFECT_SOUND_LOOP,0>,EFFECT_USER8>,
// //   // TransitionEffectL<TrDoEffectAlways<TrInstant,EFFECT_USER8,0>,EFFECT_BOOT>,
// //   // TransitionEffectL<TrDoEffectAlways<TrInstant,EFFECT_USER8,0>,EFFECT_NEWFONT>,

// //   // TransitionEffectL<TrDoEffectAlways<TrInstant,EFFECT_USER8,0>,EFFECT_IGNITION>,
// //   // TransitionEffectL<TrDoEffectAlways<TrInstant,EFFECT_USER8,0>,EFFECT_RETRACTION>,
// //   // TransitionEffectL<TrDoEffectAlways<TrInstant,EFFECT_SOUND_LOOP,0>,EFFECT_USER5>,
// //   // On-Demand
// //     OnDemandVolumeLevel,
...
{ "a_ARCANN/Arcann_KSxK;ProffieOS_V2_Voicepack_Arcann/Masked/common;commonBU", "a_ARCANN/tracks/Arcann_The_Usurper_No_Chorus.wav", // AudioFlicker Default = Golden Yellow Color Wheel Changeable 
  StylePtr<Layers<
  ...
  >>(),
  StylePtr<ChamberTop>(),
  StylePtr<ChamberBottom>(),
"arcann KSxK"},

{ "a_ARCANN/Thexan_KSxK;ProffieOS_V2_Voicepack_Arcann/Masked/common;commonBU", "a_ARCANN/tracks/Vaylin_The_Prodigy.wav", // 5 AudioFlicker Default = Golden Yellow Color Wheel Changeable 
  StylePtr<Layers<
    AudioFlicker<RotateColorsX<Variation,Rgb<180,130,0>>,RotateColorsX<Variation,Rgb<90,65,0>>>,
    BC_effects_1,
    BC_Bend7_Spark_WavOUT_NoSpark_WavIN,
...
{ "aa_BK/The_Wicked;ProffieOS_V2_Voicepack_Arcann/Masked/common;commonBU", "aa_BK/The_Wicked/wick-trk.wav",
  StylePtr<Layers<
...
// BC Swing to full
    // Mix<SwingSpeed<400>,StyleFire<Gradient<DarkOrange,OrangeRed,Red>,Orange,0,4,FireConfig<100,2500,40>,FireConfig<50,1000,0>,FireConfig<50,10,10>,FireConfig<0,0,13>>,StyleFire<Red,Orange,0,5,FireConfig<100,1800,15>,FireConfig<50,1000,30>,FireConfig<50,10,10>,FireConfig<0,0,13>>>,
// Fett Real Flame plus swing, so bladeangle and swing make intensity changes
Mix<SmoothStep<Scale<IsLessThan<BladeAngle<>,Int<16000>>,Int<36000>,Scale<BladeAngle<>,Int<10924>,Int<54000>>>,Scale<IsLessThan<BladeAngle<>,Int<16000>>,Int<-1>,Scale<BladeAngle<>,Int<-10000>,Int<-1>>>>,Black,Remap<Scale<RampF,Int<0>,Scale<IsLessThan<BladeAngle<>,Int<15000>>,Int<32768>,Scale<BladeAngle<0,15000>,Int<60000>,Int<32768>>>>,Layers<
  Mix<BladeAngle<>,StaticFire<Gradient<DarkOrange,OrangeRed,Red>,Orange,0,2,0,1800,10>,Mix<SwingSpeed<400>,StyleFire<Gradient<DarkOrange,OrangeRed,Red>,Orange,0,4,FireConfig<100,2500,25>,FireConfig<5000,1000,0>,FireConfig<50,100,10>,FireConfig<0,0,0>>,StyleFire<Red,Orange,0,5,FireConfig<100,1800,15>,FireConfig<50,1000,30>,FireConfig<50,10,10>,FireConfig<0,0,13>>>>>>>,
BC_effects_Red,
...
{ "a_ARCANN/Arcann_EHA;ProffieOS_V2_Voicepack_Arcann/Masked/common;commonBU", "a_ARCANN/tracks/Father_Vs_Son.wav", // 5 AudioFlicker Default = Golden Yellow Color Wheel Changeable 
  StylePtr<Layers<
    AudioFlicker<RotateColorsX<Variation,Rgb<180,130,0>>,RotateColorsX<Variation,Rgb<90,65,0>>>,
    BC_effects_1,
    BC_Bend7_Spark_WavOUT_NoSpark_WavIN,
...
{ "a_ARCANN/Dark_Knights_KotFE;ProffieOS_V2_Voicepack_Arcann/Unmasked/common;commonBU", "a_ARCANN/tracks/Mother_Vs_Daughter.wav", // 5 AudioFlicker Default = Golden Yellow Color Wheel Changeable 
  StylePtr<Layers<
    AudioFlicker<RotateColorsX<Variation,Rgb<180,130,0>>,RotateColorsX<Variation,Rgb<90,65,0>>>,
    BC_effects_1,
    BC_Bend7_Spark_WavOUT_NoSpark_WavIN,
...
{ "a_ARCANN/Eternal_Prince;ProffieOS_V2_Voicepack_Arcann/Unmasked/common;commonBU", "a_ARCANN/tracks/track3 .wav", // 5 AudioFlicker Default = Golden Yellow Color Wheel Changeable 
  StylePtr<Layers<
    AudioFlicker<RotateColorsX<Variation,Rgb<180,130,0>>,RotateColorsX<Variation,Rgb<90,65,0>>>,
    BC_effects_1,
    BC_Bend7_Spark_WavOUT_NoSpark_WavIN,
...
// // TransitionEffectL<TrConcat<TrInstant,Strobe<Black,Green,10,100>,TrDelay<1500>>,EFFECT_ACCENT_SWING>,
// // TransitionEffectL<TrConcat<TrInstant,Strobe<Black,Blue,10,100>,TrDelay<1500>>,EFFECT_ACCENT_SLASH>,
...
{ NO_BLADE,
  WS281XBladePtr<5, bladePin, Color8::GRB, PowerPINS<bladePowerPin4, bladePowerPin5> >(),
  WS281XBladePtr<1, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin2> >(),
  WS281XBladePtr<1, blade3Pin, Color8::GRB, PowerPINS<bladePowerPin3> >(),
  CONFIGARRAY(arcann),
"00_noblade_save"},


{ 9170,  // 110 blade
  WS281XBladePtr<144, bladePin, Color8::GRB, PowerPINS<bladePowerPin4, bladePowerPin5> >(),
  WS281XBladePtr<1, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin2> >(),
  WS281XBladePtr<1, blade3Pin, Color8::GRB, PowerPINS<bladePowerPin3> >(),
  CONFIGARRAY(arcann),
"01_arcann_save"},
