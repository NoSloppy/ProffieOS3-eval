...
/*__Presets List___
aa_Kyberphonic/Son_Of_Corellia
aa_Cosmic_Ape/CA_74Z
aa_SabersForever/CorranHorn
aa_SabersForever/SpeederBike
aa_Madcow/Corellian // BC_12color_8effect_SS
aa_NoSloppy/TheMaw
aa_NoSloppy/Crushed
aa_Blueforce/DarkSpace
...
{ "aa_JayDalorian/Parsec1;common;commonBU", "",
  // Main Blade
  StylePtr<Layers<
...
{ "aa_JayDalorian/Eternal/Luna;common;commonBU", "aa_JayDalorian/Eternal/tracks/eternal.wav",
  StylePtr<Layers<
    AudioFlicker<RotateColorsX<Variation,Rgb<0,40,128>>,RotateColorsX<Variation,Rgb<0,60,200>>>,
    TransitionLoopL<TrWaveX<HumpFlickerL<RotateColorsX<Variation,Blue>,40>,Int<350>,Int<100>,Int<600>,Int<0>>>,
    TransitionLoopL<TrWaveX<HumpFlickerL<RotateColorsX<Variation,Magenta>,40>,Int<350>,Int<100>,Int<400>,Int<0>>>,
    BC_effects_1,
    TransitionEffectL<TrConcat<TrInstant,HumpFlickerL<FloralWhite,40>,TrFade<800>>,EFFECT_IGNITION>,
    TransitionEffectL<TrConcat<TrInstant,HumpFlickerL<RotateColorsX<Variation,FloralWhite>,40>,TrFade<1200>>,EFFECT_RETRACTION>,
    InOutTrL<TrWipeSparkTip<White,300>,TrWipeInSparkTipX<LightCyan,WavLen<EFFECT_RETRACTION>,Int<401>>>,
    TransitionEffectL<TrConcat<TrDelay<300>,AlphaL<RandomPerLEDFlickerL<DeepSkyBlue>,SmoothStep<Int<4000>,Int<-4000>>>,TrDelay<1418>>,EFFECT_PREON>,
    TransitionEffectL<TrConcat<TrWipe<250>,BrownNoiseFlickerL<White,Int<200>>,TrWipe<250>>,EFFECT_PREON>,
    // Volume Level - gradient Blue -> Green
    OnDemandVolumeLevel,
    // On-Demand Battery Level
    OnDemandBatteryLevel
...
{ 0, // CT_A 132
  ...
  WS281XBladePtr<3, blade3Pin, Color8::GRB, PowerPINS<bladePowerPin6> >(), // Battery Chamber
  WS281XBladePtr<10, blade4Pin, Color8::GRB, PowerPINS<bladePowerPin6> >(), // Crystal
  CONFIGARRAY(Corran),
"00_Corran_save" }
