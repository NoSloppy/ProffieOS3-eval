...
/*__Presets List___
a_DARKSABER/DarkV3
a_DARKSABER/Darkstar
a_DARKSABER/N1
a_DARKSABER/BOBA_S1E5_MANDO_SABER
aa_Blueforce/IgnitionUltimate
aa_Blueforce/CyberAssassin2
aa_Blueforce/LiquidStatic
aa_SyntheticEpiphany/Insurrection
aa_BK/MysticMaster
aa_BK/Relictron
*/
  ...
  Layers<
  White,
  InOutTrL<TrWipe<500>,TrWipeInX<WavLen<>>>,
  AlphaL<White,SmoothStep<Scale<Trigger<EFFECT_RETRACTION,Int<1>,Percentage<WavLen<EFFECT_RETRACTION>,95>,WavLen<EFFECT_RETRACTION>,Int<1>>,Int<-1>,Int<4000>>,Int<-1>>>
  >
...
// StylePtr<Black>(),
//   StylePtr<Layers<
// Stripes<16000,100,Red,Black,Green,Black,Blue,Black,White,Black,Rainbow,Black,Yellow,Black,Rgb<60,0,255>,Black>,

//   EffectSequence<EFFECT_USER1,AlphaL<Black,Int<0>>,Green>,
//   BC_effects_1,
...
{ "a_DARKSABER/DarkV3;common;commonBU", "a_DARKSABER/DarkV3/tracks/Mandalorian.wav",
  StylePtr<Layers<
    ...
    AlphaL<White,SmoothStep<Scale<Trigger<EFFECT_RETRACTION,Int<1>,Percentage<WavLen<EFFECT_RETRACTION>,80>,WavLen<EFFECT_RETRACTION>,Int<1>>,Int<-1>,Int<4000>>,Int<-1>>>
  // Volume Level - gradient Blue -> Green
    OnDemandVolumeLevel,
  // On-Demand Battery Level
    OnDemandBatteryLevel
...
{ "a_DARKSABER/N1;common;commonBU", "a_DARKSABER/N1/tracks/track3.wav",
  StylePtr<Layers<
  	StyleFire<Black,Rgb<60,0,255>,0,4,FireConfig<100,3000,0>,FireConfig<3000,3000,0>,FireConfig<400,1000,0>,FireConfig<0,0,5>>,
		AlphaL<RotateColorsX<Variation,Rgb<20,10,225>>,SwingSpeed<600>>,
    BC_effects_White,
   InOutTrL<TrWipeSparkTipX<White,BendTimePowInvX<Int<1000>,Int<180000>>>,TrWipeInX<BendTimePowX<WavLen<EFFECT_RETRACTION>,Int<180000>>>>,
  // Volume Level - gradient Blue -> Green
    OnDemandVolumeLevel,
...
// Crystal
  StylePtr<Layers<
    ...
    InOutTrL<TrInstant,TrInstant,Cylon<Rgb<0,0,128>,20,10,AlphaL<Red,Int<0>>,5,20,300>>>>(),
"   n1\nstarfighter"},

{ "a_DARKSABER/BOBA_S1E5_MANDO_SABER;common;commonBU", "",
  StylePtr<Layers<
    Mix<SwingSpeed<400>,Rgb<80,100,150>,Rgb<130,150,225>>,
    BrownNoiseFlickerL<Stripes<5000,-300,Rgb<15,25,55>,Rgb<60,75,120>,Rgb<0,10,20>,Rgb<40,50,75>>,Int<38400>>,
    AudioFlickerL<Rgb<25,35,75>>,
    AlphaL<Rgb<155,175,225>,SwingSpeed<600>>,
...
// Crystal
  StylePtr<Layers<
    Pulsing<RandomFlicker<Blue,Rgb<155,175,225>>,Black,800>,
    InOutTrL<TrInstant,TrInstant,Cylon<Rgb<155,175,225>,20,10,AlphaL<Red,Int<0>>,5,20,300>>>>(),
"boba s1e5\nmando saber"},
...
// Comment out this following line for non-stutter on actual ignition - wav needed
...
{ "aa_Blueforce/LiquidStatic;common;commonBU", "",
  StylePtr<Layers<
    ...
    BC_effects_1,
    InOutTrL<TrWipeSparkTipX<White,BendTimePowInvX<Int<1000>,Int<180000>>>,TrWipeInSparkTipX<LightCyan,BendTimePowX<WavLen<EFFECT_RETRACTION>,Int<180000>>,Int<401>>>,
...
// Main Blade
    StylePtr<Layers<
      ...
      BC_effects_Red,
      InOutTrL<TrWipeSparkTipX<White,BendTimePowInvX<Int<2200>,Int<180000>>,Int<300>>,TrColorCycleX<WavLen<EFFECT_RETRACTION>,-100,-600>>,
...
// Crystal
  StylePtr<Layers<
    Pulsing<RotateColorsX<Variation,Rgb<95,0,210>>,Black,200>,
    InOutTrL<TrInstant,TrInstant,Pulsing<Black,RotateColorsX<Variation,Rgb<95,0,210>>,3000>>>>(),
"insurrection"},

{ "aa_BK/MysticMasterV2;common;commonBU", "",
  StylePtr<Layers<
...
// Crystal
  StylePtr<Layers<
    Pulsing<RotateColorsX<Variation,Rgb<175,175,225>>,Black,200>,
    InOutTrL<TrInstant,TrInstant,Pulsing<Black,RotateColorsX<Variation,Rgb<175,175,225>>,3000>>>>(),
"mystic\nmaster"},
...
// Main Blade
    ...
    BC_effects_1,
  // Ignition and Retraction - new TrLoopNX, and no intermediate color
		//TransitionEffectL<TrConcat<TrDelay<1000>,TrSmoothFade<800>,White,TrLoopNX<Int<5>,TrJoin<TrSmoothFade<500>,TrWipe<500>>>>,EFFECT_IGNITION>, // nope- no color to fade
    TransitionEffectL<TrConcat<TrDelay<400>,AlphaL<Black,Int<0>>,TrSmoothFade<600>,White,TrSmoothFade<700>>,EFFECT_IGNITION>,
    InOutTrL<TrWipeSparkTipX<White,BendTimePowInvX<Int<1000>,Int<180000>>>,TrWipeInSparkTipX<White,BendTimePowX<WavLen<>,Int<180000>>,Int<401>>>,
    // Volume Level - gradient Blue -> Green
    OnDemandVolumeLevel,
  // On-Demand Battery Level
    OnDemandBatteryLevel
...
// 	{ "aa_Kyberphonic/Son_Of_Corellia;common;commonBU", "",
//   StylePtr<Layers<
//     BrownNoiseFlicker<Stripes<10000,-3000,Cyan,Rgb<100,100,150>>,Blue,100>,
// 	  // Swing Color
...
//         InOutTrL<TrJoin<TrWipe<500>,TrWipeIn<500>>,TrColorCycleX<WavLen<EFFECT_RETRACTION>,2000,-600>>,
...
//         TransitionEffectL<TrConcat<TrFadeX< Percentage<WavLen<EFFECT_PREON>,30> >,AlphaL<BrownNoiseFlicker<RotateColorsX<Variation,Blue>,Rgb<100,100,150>,300>,LayerFunctions<Bump<Int<0>,Int<10000>>,Bump<Int<32768>,Int<10000>>>>,TrDelayX< Percentage<WavLen<EFFECT_PREON>,70> >>,EFFECT_PREON>,
// 	  // Volume Level - gradient Blue -> Green
// 	    OnDemandVolumeLevel,
// 	  // On-Demand Battery Level
// 	    OnDemandBatteryLevel
...
// // Hilt
//   StylePtr<Layers<
// 		ColorCycle<TransitionLoop<Black,TrConcat<TrInstant,
// 			AlphaL<Red,LinearSectionF<Int<5462>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Red,LinearSectionF<Int<16384>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blinking<Red,Black,500,500>,LinearSectionF<Int<27306>,Int<8000>>>,TrDelay<2000>>>,100,30,OrangeRed,15,200,500>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
// 	  Pulsing<RandomFlicker<Rgb<0,128,0>,Yellow>,Rgb<100,100,0>,1500>,
// 	  BlastFadeoutL<Blue,400>,
// 	  LockupL<Blinking<Yellow,Black,85,500>,AudioFlicker<Yellow,Blue>,Int<32768>,Int<32768>,Int<32768>>,
// 	  SimpleClashL<White,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,White,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
// 	  InOutTrL<TrWipeSparkTip<White,500,75>,TrColorCycle<3000,1>,Cylon<Yellow,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),

// 	"son of\ncorellia"},


// 	{ "aa_Cosmic_Ape/CA_74Z;common;commonBU", "aa_Cosmic_Ape/CA_74Z/tracks/track1.wav",
...
// 	  TransitionEffectL<TrConcat<TrInstant,SparkleL<AudioFlicker<Stripes<10000,-3000,Cyan,Rgb<100,100,150>>,Blue>>,TrFadeX<Percentage<WavLen<EFFECT_RETRACTION>,40>>,AlphaL<AudioFlicker<Stripes<10000,-3000,Cyan,Rgb<100,100,150>>,Blue>,Bump<Scale<Trigger<EFFECT_RETRACTION,Int<1>,Int<800>,Int<800>>,Int<-5000>,Int<1000>>,Int<10000>>>,TrDelayX<Percentage<WavLen<>,60>>>,EFFECT_RETRACTION>,
// 	  TransitionEffectL<TrConcat<TrDelay<133>,AlphaL<Black,Int<0>>,TrJoin<TrWipeInX<WavLen<EFFECT_RETRACTION>>,TrSparkX<White,Int<200>,WavLen<EFFECT_RETRACTION>,Int<32768>>>>,EFFECT_RETRACTION>,
...
//   StylePtr<Layers<
// 		ColorCycle<TransitionLoop<Black,TrConcat<TrInstant,
// 			AlphaL<Blue,LinearSectionF<Int<5462>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blue,LinearSectionF<Int<16384>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blinking<Blue,Black,500,500>,LinearSectionF<Int<27306>,Int<8000>>>,TrDelay<2000>>>,100,30,Cyan,15,200,500>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
...
// 	  InOutTrL<TrWipeSparkTip<White,500,75>,TrColorCycle<3000,1>,Cylon<Green,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),
// "ca_74z"},

// 	{ "aa_SabersForever/CorranHorn;common;commonBU", "aa_SabersForever/CorranHorn/tracks/probe_droid_battle.wav",
// 	StylePtr<Layers<
// 		AudioFlicker<Stripes<5000,-2000,Green,Rgb<100,100,150>>,Green>,
//     BC_effects_1, 
//     // Engines Starting Ignition, cyle down retraction
//         InOutTrL<TrJoin<TrWipe<500>,TrWipeIn<500>>,TrColorCycleX<WavLen<EFFECT_RETRACTION>,2000,-600>>,
//         TransitionEffectL<TrConcat<TrInstant,StrobeL<AlphaL<White,LayerFunctions<Bump<Int<0>>,Bump<Int<32768>>>>,Int<25>,Int<30>>,TrFade<1500>>,EFFECT_IGNITION>,
...
//   StylePtr<Layers<
// 		ColorCycle<TransitionLoop<Black,TrConcat<TrInstant,
// 			AlphaL<Rgb<100,100,100>,LinearSectionF<Int<5462>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Rgb<100,100,100>,LinearSectionF<Int<16384>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blinking<Rgb<100,100,100>,Black,500,500>,LinearSectionF<Int<27306>,Int<8000>>>,TrDelay<2000>>>,100,30,White,15,200,500>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
// 	  Pulsing<RandomFlicker<Rgb<0,128,0>,Cyan>,Black,800>,
// 	  BlastFadeoutL<Blue,400>,  
// 	  LockupL<Blinking<Cyan,Black,85,500>,AudioFlicker<Yellow,Blue>,Int<32768>,Int<32768>,Int<32768>>,
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
// 	  InOutTrL<TrWipeSparkTip<White,500,75>,TrColorCycle<3000,1>,Cylon<Cyan,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),
// 	"corran\nhorn"},


// 	{ "aa_SabersForever/SpeederBike;common;commonBU", "aa_SabersForever/CorranHorn/tracks/probe_droid_battle.wav",
//   StylePtr<Layers<
//     BrownNoiseFlicker<Stripes<10000,-3000,Cyan,Rgb<100,100,150>>,Blue,100>,
// 	  // Swing Color
// 	    //AlphaL<Pulsing<Blue,LightCyan,1000>,Scale<IsLessThan<SwingSpeed<600>,Int<13600>>,Scale<SwingSpeed<600>,Int<-19300>,Int<32768>>,Int<0>>>,
...
//   StylePtr<Layers<
// 		ColorCycle<TransitionLoop<Black,TrConcat<TrInstant,
// 			AlphaL<Rgb<100,0,0>,LinearSectionF<Int<5462>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Rgb<100,0,0>,LinearSectionF<Int<16384>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blinking<Rgb<100,0,0>,Black,500,500>,LinearSectionF<Int<27306>,Int<8000>>>,TrDelay<2000>>>,100,30,OrangeRed,15,200,500>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
// 	  Pulsing<RandomFlicker<Rgb<0,128,0>,Yellow>,Black,800>,
// 	  BlastFadeoutL<Blue,400>,  
// 	  LockupL<Blinking<Yellow,Black,85,500>,AudioFlicker<Yellow,Blue>,Int<32768>,Int<32768>,Int<32768>>,
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
...
// 	{ "aa_Madcow/Corellian;common;commonBU", "",
...
//   StylePtr<Layers<
// 		ColorCycle<TransitionLoop<Black,TrConcat<TrInstant,
// 			AlphaL<Rgb<0,100,0>,LinearSectionF<Int<5462>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Rgb<0,100,0>,LinearSectionF<Int<16384>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blinking<Rgb<0,100,0>,Black,500,500>,LinearSectionF<Int<27306>,Int<8000>>>,TrDelay<2000>>>,100,30,Green,15,200,500>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
...
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
// 	  InOutTrL<TrWipeSparkTip<White,500,75>,TrColorCycle<3000,1>,Cylon<Rgb<0,0,128>,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),
// 	"corellian"},
...
// // Hilt
//   StylePtr<Layers<
//   	ColorCycle<Rgb<60,0,255>,15,30,White,15,200,100>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
// 	  Pulsing<RandomFlicker<Blue,Rgb<60,0,255>>,Black,800>,
// 	  BlastFadeoutL<Blue,400>,  
// 	  LockupL<Blinking<Cyan,Black,85,500>,AudioFlicker<Yellow,Blue>,Int<32768>,Int<32768>,Int<32768>>,
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
...
//   InOutTrL<TrJoin<TrWipeX<BendTimePowX<Int<1300>,Int<16384>>>,TrSparkX<White,Int<400>,BendTimePowX<Int<1300>,Int<16384>>,Int<0>>>,TrWipeInX<BendTimePowX<WavLen<EFFECT_RETRACTION>,Int<150000>>>>,
...
// // Hilt
//   StylePtr<Layers<
//   	ColorCycle<Rgb16<22863,5695,53231>,15,30,White,15,200,100>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
...
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
// 	  InOutTrL<TrWipeSparkTip<White,500,75>,TrColorCycle<3000,1>,Cylon<Rgb<180,0,0>,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),
// "crushed"},
...
//   StylePtr<Layers<
// 		ColorCycle<TransitionLoop<Black,TrConcat<TrInstant,
// 			AlphaL<Rgb<95,0,210>,LinearSectionF<Int<5462>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Rgb<95,0,210>,LinearSectionF<Int<16384>,Int<8000>>>,TrDelay<1000>,
// 			AlphaL<Blinking<Rgb<95,0,210>,Black,500,500>,LinearSectionF<Int<27306>,Int<8000>>>,TrDelay<2000>>>,100,30,Rgb<75,0,165>,15,200,500>,
// 		BC_effects_2
// 	>>(),
// // Crystal
//   StylePtr<Layers<
...
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
// 	  InOutTrL<TrWipeSparkTip<White,500,75>,TrColorCycle<3000,1>,Cylon<Rgb<95,0,210>,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),
//  "dark space"},
...
// //   Layers<TransitionEffectL<TrConcat<TrSmoothFadeX<Percentage<WavLen<EFFECT_FORCE>,20>>,Strobe<Black,Rgb<80,0,0>,30,30>,TrFadeX<Percentage<WavLen<EFFECT_FORCE>,60>>,StaticFire<Red,Strobe<Black,Cyan,30,30>,0,3,300>,TrFadeX<Percentage<WavLen<EFFECT_FORCE>,20>>>,EFFECT_FORCE>,
// //     EffectSequence<EFFECT_POWERSAVE,AlphaL<Black,Int<16384>>,AlphaL<Black,Int<0>>>,
// //     TransitionEffectL<TrConcat<TrInstant,GreenYellow,TrDelay<25>,AlphaL<TransitionEffect<TransitionEffect<Strobe<Black,Yellow,20,20>,BrownNoiseFlicker<Rgb<100,200,255>,Black,300>,TrInstant,TrFadeX<Percentage<WavLen<EFFECT_CLASH>,35>>,EFFECT_CLASH>,Rgb<100,200,255>,TrInstant,TrDelayX<Percentage<WavLen<EFFECT_CLASH>,25>>,EFFECT_CLASH>,Bump<Scale<BladeAngle<>,Int<25000>,Int<8000>>,Int<18000>>>,TrFadeX<Percentage<WavLen<EFFECT_CLASH>,65>>>,EFFECT_CLASH>,
// //     TransitionEffectL<TrConcat<TrInstant,GreenYellow,TrDelay<25>,AlphaL<Black,Int<0>>,TrWipeInX<Percentage<WavLen<EFFECT_STAB>,30>>,AlphaL<Stripes<5000,1000,Orange,DarkOrange,Rgb<150,60,0>,Rgb<60,30,0>,Rgb<150,14,0>,OrangeRed>,SmoothStep<Int<20000>,Int<20000>>>,TrJoin<TrSmoothFadeX<Percentage<WavLen<EFFECT_STAB>,90>>,TrWipeX<Percentage<WavLen<EFFECT_STAB>,70>>>>,EFFECT_STAB>,
...
// //     LockupTrL<Layers<AlphaL<Black,Int<16000>>,AlphaL<White,StrobeF<Scale<SlowNoise<Int<1000>>,Int<1>,Int<6>>,Scale<SlowNoise<Int<1000>>,Int<10>,Int<50>>>>,
...
// //     LockupTrL<AlphaL<Remap<Scale<RampF,Int<65536>,Int<0>>,StaticFire<Mix<TwistAngle<>,Rgb16<20393,93,93>,DarkOrange>,Mix<TwistAngle<>,Rgb16<20393,93,93>,Orange>,0,4,5,4000,10>>,
// //         SmoothStep<Scale<TwistAngle<>,Int<22000>,Int<29000>>,Int<4000>>>,
// //         TrConcat<TrInstant,GreenYellow,TrDelay<25>,AlphaL<Black,Int<0>>,TrWipeIn<600>,AlphaL<Red,SmoothStep<Scale<TwistAngle<>,Int<24000>,Int<29000>>,Int<2000>>>,TrExtend<3000,TrFade<300>>,AlphaL<Mix<TwistAngle<>,Red,Orange>,SmoothStep<Scale<TwistAngle<>,Int<24000>,Int<29000>>,Int<2000>>>,TrFade<3000>>,TrColorCycle<1500,-2000>,SaberBase::LOCKUP_MELT>,
...
// // // no effects because... blaster. But....... make toggle to stun and use stun sounds instead using alt sounds? WAITING ON FERNANDO TO GET UP TO EXPLAINING.
// // StylePtr<Layers<Black,
...
// { "testfont2b;common;commonBU", "",
//   StylePtr<Layers<Rainbow,
// TransitionEffectL<TrConcat<TrInstant,Blue,TrFade<2000>>,EFFECT_QUOTE>,
// InOutTrL<TrWipeX<BendTimePowInvX<Int<1000>,Int<180000>>>,TrWipeInX<BendTimePowX<WavLen<EFFECT_RETRACTION>,Int<180000>>>>, 
// TransitionEffectL<TrConcat<TrInstant,Strobe<Black,White,15,81>,TrCenterWipeInSpark<White,500>>,EFFECT_FAST_ON>,
//   TransitionEffectL<TrConcat<TrInstant,AlphaL<Rgb<100,200,255>,Bump<Int<0>,Int<6000>>>,TrFadeX<Percentage<WavLen<>,25>>,AlphaL<Orange,Bump<Int<0>,Int<4000>>>,TrFadeX<Percentage<WavLen<>,25>>,AlphaL<Red,Bump<Int<0>,Int<2000>>>,TrFadeX<Percentage<WavLen<>,50>>>,EFFECT_POSTOFF>,
// // // Volume Level - stepped blue "stripes"
// //   TransitionEffectL<TrConcat<TrExtendX<Int<1000>,TrSmoothFade<200>>,
// // AlphaL<Layers<
...
// 	  SimpleClashL<Yellow,100,EFFECT_CLASH,SmoothStep<Int<0>,Int<24000>>>,
// 	  LockupTrL<Pulsing<Red,Yellow,1000>,TrInstant,TrInstant,SaberBase::LOCKUP_MELT>,
// 	  InOutTrL<TrWipeSparkTip<Yellow,500,75>,TrColorCycle<3000,1>,Cylon<Green,20,10,AlphaL<Red,Int<0>>,5,20,300>>
//   >>(),
// "testfont2b"},
...
{ 0, // CT_A 132
  WS281XBladePtr<123, blade3Pin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3> >(), // HiltPCB and Main Blade in parallel
  WS281XBladePtr<3, bladePin, Color8::GRB, PowerPINS<bladePowerPin6> >(), // Battery Chamber
  CONFIGARRAY(Darksaber),
"00_Darksaber_save" }
