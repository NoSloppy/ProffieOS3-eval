//BC_Fallen_6.x// ProffieOS version 6.x - BC manual update - Native WavLen!
//Last upload : 6-14-21
...
// Version 3  of all-in-one preset, using ColorChange , losing colr wheel option.
// ---- not Yellow or Red blades (gets BC_effects_1) ----
// Base  
  StripesX<Int<16000>,Int<-1000>,
            ColorChange<TrFade<500>,Blue,             Green,            DarkOrange,       Rgb<95,0,225>,    Rgb<30,120,150>,  Rgb<180,30,140>,  Rgb<80,50,200>>,
    Pulsing<ColorChange<TrFade<500>,Rgb<0,0,90>,      Rgb<0,90,0>,      Rgb<90,24,0>,     Rgb<39,5,71>,     Rgb<11,42,53>,    Rgb<64,11,49>  ,  Rgb<28,18,71>>,
            ColorChange<TrFade<500>,Blue,             Green,            DarkOrange,       Rgb<95,0,225>,    Rgb<30,120,150>,  Rgb<180,30,140>,  Rgb<80,50,200>>,800>,
            ColorChange<TrFade<500>,Blue,             Green,            DarkOrange,       Rgb<95,0,225>,    Rgb<30,120,150>,  Rgb<180,30,140>,  Rgb<80,50,200>>>,

// Force
  TransitionEffectL<TrConcat<TrFade<600>,RandomFlicker<
            ColorChange<TrFade<500>,Blue,             Green,            DarkOrange,       Rgb<95,0,225>,    Rgb<30,120,150>,  Rgb<180,30,140>,  Rgb<80,50,200>>,
            ColorChange<TrFade<500>,Rgb<0,0,160>,     Rgb<0,160,0>,     Rgb<160,43,0>,    Rgb<69,9,125>,    Rgb<19,75,94>,    Rgb<113,19,88>,   Rgb<50,31,125>>>,
    TrDelay<3000>,
            ColorChange<TrFade<500>,Blue,             Green,            DarkOrange,       Rgb<95,0,225>,    Rgb<30,120,150>,  Rgb<180,30,140>,  Rgb<80,50,200>>,
    TrFade<800>>,EFFECT_FORCE>,

// Swing Color
  AlphaL<   ColorChange<TrFade<500>,Rgb<70,70,255>,   Rgb<100,255,100>, Rgb<255,178,110>, Rgb<160,60,255>,   Rgb<90,180,255>, Rgb<160,60,255>,  Rgb<160,60,255>>,
...
TransitionEffectL<TrConcat<TrInstant,HumpFlicker<White,Black,75>,TrSmoothFade<500>>,EFFECT_IGNITION>,
    ...
    TransitionEffectL<TrConcat<TrInstant,AlphaL<Mix<Sin<Scale<Trigger<EFFECT_RETRACTION,Int<3000>,Int<1000>,Int<500>>,Int<70>,Int<550>>>,Cyan,Rgb<160,60,255>>,Bump<Scale<Trigger<EFFECT_PREON,Int<3000>,Int<1000>,Int<500>>,Int<41000>,Int<32768>>>>,TrDelay<3000>>,EFFECT_PREON>,
      TransitionEffectL<TrConcat<
...
// // Using EFFECT_SWAP to retain individual color wheel change still as an option
//       StripesX<Int<16000>,Int<-1000>,
...
// // ---- for Yellow and Red (gets BC_effects_Red) ----
// // Base  
//   StripesX<Int<16000>,Int<-1000>,
//             ColorChange<TrFade<500>,Rgb<180,180,0>,   Red>,
//     Pulsing<ColorChange<TrFade<500>,Rgb<64,64,0>,     Rgb<90,0,0>>,
//             ColorChange<TrFade<500>,Rgb<180,180,0>,   Red>,800>,
//             ColorChange<TrFade<500>,Rgb<180,180,0>,   Red>,800>>>,

// // Force
//   TransitionEffectL<TrConcat<TrFade<600>,RandomFlicker<
//             ColorChange<TrFade<500>,Rgb<180,180,0>,   Red>,
//             ColorChange<TrFade<500>,Rgb<113,113,0>,   Rgb<160,0,0>>,
//     TrDelay<3000>,
//             ColorChange<TrFade<500>,Rgb<180,180,0>,   Red>,
//     TrFade<800>>,EFFECT_FORCE>,

// // Swing Color
//   AlphaL<   ColorChange<TrFade<500>,Rgb<230,180,80>,  Rgb<255,100,100>>,
//   Scale<IsLessThan<SwingSpeed<600>,Int<13600>>,Scale<SwingSpeed<600>,Int<-19300>,Int<32768>>,Int<0>>>,
