...
{ "a_VADER/RogueVader;common;commonBU", "a_VADER/RogueVader/tracks/Imperial_March_ROTJ.wav", // 2 AudioFlicker Red base Color Wheel Changeable
    StylePtr<Layers<
...
{ "a_LUKE/DaddyIssues;common;commonBU", "a_LUKE/DaddyIssues/tracks/Final_Duel.wav", // 1 AudioFlicker Green Color Wheel Changeable
    StylePtr<Layers<
    // Main Blade Color/Styles Base
        AudioFlicker<RotateColorsX<Variation,Green>,RotateColorsX<Variation,Rgb<0,128,0>>>,
        BC_effects_Red,
...
{ "a_LUKE/Rescue;common;commonBU", "a_LUKE/Rescue/tracks/Intro_fight.wav", // 1 AudioFlicker Green Color Wheel Changeable
    StylePtr<Layers<
    // Main Blade Color/Styles Base
        AudioFlicker<RotateColorsX<Variation,Green>,RotateColorsX<Variation,Rgb<0,128,0>>>,
        BC_effects_1,
...
{ "a_LUKE/ANH_Training;a_LUKE/ANH_Graflex;common;commonBU", "a_LUKE/ANH_Training/tracks/training_ambience.wav", // 3 AudioFlicker DeepSkyBlue Base Color Wheel Changeable
    StylePtr<Layers<
...
{ "a_LEIA/Royalty;common;commonBU", "a_LEIA/Royalty/tracks/Leia1.wav", //  3 AudioFlicker DeepSkyBlue base Color Wheel Changeable
    StylePtr<Layers<
        AudioFlicker<RotateColorsX<Variation,DeepSkyBlue>,RotateColorsX<Variation,Rgb<0,0,128>>>,
        BC_effects_1,
        // standard
...
{ "a_KYLO/SonOfDarkness;common;commonBU", "a_BANE/tracks/track4.wav", // 4 BrownNoiseFlicker Red base Color Wheel Changeable 
    StylePtr<Layers<
...
{ "a_REY/ScavngrsDstny;common;commonBU", "a_REY/ScavngrsDstny/tracks/ReyEp9End.wav", // 5 AudioFlicker Default = Golden Yellow Color Wheel Changeable 
    StylePtr<Layers<
...
{"a_LUKE/ESB_Graflex;common;commonBU", "a_LUKE/ESB_Graflex/tracks/LvsV.wav", // 6 RandomFlicker Blue base Color Wheel Changeable
    StylePtr<Layers<
...
{ "a_AHSOKA/AhsokaUltimate;common;commonBU", "a_AHSOKA/CdeFlcrm/tracks/ItsOverNow.wav", // 8 AudioFlicker Bright Swing Color Wheel Changeable - Default = Silver White
    StylePtr<Layers<
...
{ "a_AHSOKA/TheJediMandoEp;common;commonBU", "a_AHSOKA/TheJediMandoEp/tracks/Mando.wav", // 8 AudioFlicker Bright Swing Color Wheel Changeable - Default = Silver White 
    StylePtr<Layers<
        Mix<SwingSpeed<500>,AudioFlicker<RotateColorsX<Variation,Rgb<110,150,255>>,RotateColorsX<Variation,Rgb<80,90,130>>>,Mix<SwingSpeed<800>,AudioFlicker<RotateColorsX<Variation,Rgb<110,150,255>>,RotateColorsX<Variation,White>>,RotateColorsX<Variation,White>>>,
        BC_effects_White,
        // standard
...
{ "TheWhite;common;commonBU", "", // 8 AudioFlicker Bright Swing Color Wheel Changeable - Default = Silver White
  StylePtr<Layers<
    Mix<SwingSpeed<500>,AudioFlicker<RotateColorsX<Variation,Rgb<110,150,255>>,RotateColorsX<Variation,Rgb<80,90,130>>>,Mix<SwingSpeed<800>,AudioFlicker<RotateColorsX<Variation,Rgb<110,150,255>>,RotateColorsX<Variation,White>>,RotateColorsX<Variation,White>>>,
    BC_effects_White,
    // standard
...
{ "Nextor;common;commonBU", "", // 9 HumpFlicker Blade Default = PurpleBlue  
    StylePtr<Layers<
...
{"a_SHIPS/Tie;common;commonBU", "a_SHIPS/Tie/tracks/Tie.wav", // 11 Stripes based Pulse - Default = Green Color Wheel Changeable   
    StylePtr<Layers< 
...
{"a_SHIPS/Xwing;common;commonBU", "a_SHIPS/Xwing/tracks/Xwing.wav", // 11 Stripes Pulse - Default = Red base Color Wheel Changeable   
    StylePtr<Layers<    
...
{"a_SHIPS/Slave1;common;commonBU", "a_SHIPS/Slave1/tracks/Pursuit.wav", // Center out stripes - custom preon and ignition
...
{"Proto2;common;commonBU", "Proto2/tracks/proto2.wav", // 12 Color Cycle to Glitchy Pulsing Blade Default = Green
    StylePtr<Layers<   
...
"proto 2"},
 ...
 // "Battery\nlevel bc"}
    ...
    // { "BattLevl;common;commonBU", "tracks/Ambience.wav",
    // &style_charging,
    //Side 2
    // &style_charging,
    // StylePtr<Black>(),
...
// { "a_LUKE/LS6;common;commonBU", "a_LUKE/LS6/tracks/jabba_scene.wav", // AudioFlicker Green Color Wheel Changeable
...
//  { "Calibr8;common;commonBU", "tracks/TalesOfAJediKnight.wav",                            
// // Emitter PCB and Main Blade
//     StylePtr<Black>(),
// // Chassis PCB
//     StylePtr<Layers<
...
// //  { "testfont2;common;commonBU", "tracks/theforce1.wav",
// //     StylePtr<Black>(),
// //     StylePtr<Stripes<16000,100,Red,Black,Green,Black,Blue,Black,White,Black,Yellow,Black,Rgb<60,0,255>,Black>>(),
// //     StylePtr<Stripes<16000,100,Red,Black,Green,Black,Blue,Black,White,Black,Yellow,Black,Rgb<60,0,255>,Black>>(),
// //     StylePtr<Stripes<16000,100,Red,Black,Green,Black,Blue,Black,White,Black,Yellow,Black,Rgb<60,0,255>,Black>>(),
