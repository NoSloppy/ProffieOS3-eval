// BC_VenZallow_6.x.h 97% FLASH Serial + Mass Storage ** Sketch uses 261688 bytes (99%) of program storage space. Maximum is 262144 bytes.
...
// aa_Fourzze/GrandLegacy                 // Leia's style
2. aa_LINK/Purged                         // ShockBaton
3. a_ARCANN/EternalPrince                 // Custom Yellow-Orange
4. a_CAL_KESTIS/AllThatRemains            // Fallen Order Blue
5. aa_Fourzze/Betrayal                    // Fallen Order Purple
6. a_SAVAGE/Mauls_Brother                 // Yellow HumpFlicker
7. aa_KYBERPHONIC/Metamorphose            // Custom Morphing colors (Sin)
8. Mortal_Kombat_Raiden                   // Jason Sawyer's custom blade style
9. Kachow                                 // Bren's Lightning Mcqueen, edited by me.
10. aa_Greyscale/Galvanic_Greyscale       // KidsTryThisAtHome custom for Greyscale Galvanic (BC Effects)
11. aa_JayDalorian/LightsaberOfTheBells   // JayDalorian's style (BC Effects)
12. Proxima                               // Nathan Donovan's IT 2017 SmokeBlade (BC Effects)
*/


Preset VenZallow [] = {

{ "a_VEN_ZALLOW/LastLineofDefense;common;commonBU", "", // 1 AudioFlicker Green Color Wheel Changeable
/* Â© Fett263 Rotoscope with Emitter Spark (Primary Blade) OS6 Style
Style Options
...
*/
  ...
  StylePtr<Layers<
    ColorSelect<IntArg<STYLE_OPTION_ARG, 0>,TrInstant,AudioFlicker<Stripes<10000,-2600,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,Mix<Int<7710>,Black,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,Mix<Int<16448>,Black,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>,AudioFlicker<Stripes<10000,-2600,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,RgbArg<ALT_COLOR_ARG,Rgb<255,68,0>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,Mix<Int<16448>,Black,RgbArg<ALT_COLOR_ARG,Rgb<255,68,0>>>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>,AudioFlicker<Stripes<12000,-1800,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,Mix<Int<11565>,Black,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,Mix<Int<16448>,Black,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>,AudioFlicker<Stripes<12000,-1800,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,RgbArg<ALT_COLOR_ARG,Rgb<255,68,0>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>,Mix<Int<16448>,Black,RgbArg<ALT_COLOR_ARG,Rgb<255,68,0>>>>,RgbArg<BASE_COLOR_ARG,Rgb<0,255,0>>>>,
    AlphaL<AudioFlickerL<RgbArg<EMITTER_COLOR_ARG,Rgb<255,255,255>>>,SmoothStep<IntArg<EMITTER_SIZE_ARG,3000>,Int<-2000>>>,
    ...
    TransitionEffectL<TrSelect<IntArg<PREON_OPTION_ARG,0>,TrInstant,TrConcat<TrInstant,AlphaL<Mix<Trigger<EFFECT_PREON,Mult<Int<16384>,WavLen<EFFECT_PREON>>,Mult<Int<10922>,WavLen<EFFECT_PREON>>,Mult<Int<5462>,WavLen<EFFECT_PREON>>>,BrownNoiseFlicker<Black,RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,100>,RandomPerLEDFlicker<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,Rgb<50,50,50>>,BrownNoiseFlicker<Mix<NoisySoundLevel,RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,RotateColorsX<Int<4000>,RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>>>,White,50>>,SmoothStep<Scale<NoisySoundLevel,Int<-10000>,Int<36000>>,Int<-4000>>>,TrDelayX<WavLen<EFFECT_PREON>>>,TrConcat<TrInstant,AlphaL<RandomPerLEDFlicker<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,Black>,SmoothStep<Scale<NoisySoundLevel,Int<-10000>,Int<36000>>,Int<-4000>>>,TrDelayX<WavLen<EFFECT_PREON>>>,TrConcat<TrFadeX<Mult<Int<8192>,WavLen<EFFECT_PREON>>>,AlphaL<HumpFlickerL<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,10>,SmoothStep<IntArg<PREON_SIZE_ARG,2000>,Int<-4000>>>,TrFadeX<Mult<Int<8192>,WavLen<EFFECT_PREON>>>,AlphaL<HumpFlickerL<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,15>,SmoothStep<Sum<Int<2000>,IntArg<PREON_SIZE_ARG,2000>>,Int<-4000>>>,TrFadeX<Mult<Int<8192>,WavLen<EFFECT_PREON>>>,AlphaL<HumpFlickerL<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,20>,SmoothStep<Sum<Int<4000>,IntArg<PREON_SIZE_ARG,2000>>,Int<-4000>>>,TrBoingX<Mult<Int<8192>,WavLen<EFFECT_PREON>>,3>>,TrConcat<TrBoingX<Mult<Int<10922>,WavLen<EFFECT_PREON>>,5>,AlphaL<BrownNoiseFlickerL<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,Int<100>>,SmoothStep<IntArg<PREON_SIZE_ARG,2000>,Int<-4000>>>,TrBoingX<Mult<Int<10922>,WavLen<EFFECT_PREON>>,3>,Black,TrBoingX<Mult<Int<7260>,WavLen<EFFECT_PREON>>,3>,AlphaL<BrownNoiseFlickerL<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,Int<200>>,SmoothStep<Sum<Int<4000>,IntArg<PREON_SIZE_ARG,2000>>,Int<-4000>>>,TrBoingX<Mult<Int<3664>,WavLen<EFFECT_PREON>>,3>>,TrConcat<TrFadeX<Mult<Int<4096>,WavLen<EFFECT_PREON>>>,AlphaL<PulsingL<RgbArg<PREON_COLOR_ARG,Rgb<0,255,0>>,Int<800>>,SmoothStep<IntArg<PREON_SIZE_ARG,2000>,Int<-4000>>>,TrDelayX<Mult<Int<28672>,WavLen<EFFECT_PREON>>>>>,EFFECT_PREON>,
