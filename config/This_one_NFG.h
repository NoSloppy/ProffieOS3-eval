...
{ "testfont2b", "tracks/track1.wav",
  ...
  // StylePtr<Layers<
  //   Black,
  //   TransitionLoopL<TrConcat<TrInstant,White,TrDelay<400>,Black,TrDelay<100>>>,
  //   InOutTrL<TrInstant,TrInstant,Blinking<Black,White,1500,500>>>>(),
  // // 3mm YellowGreen
  // StylePtr<Layers<
  //   Black,
  //   TransitionLoopL<TrConcat<TrDelay<100>,White,TrDelay<300>,Black,TrDelay<100>>>,
  //   InOutTrL<TrInstant,TrInstant,Blinking<Black,White,1500,500>>>>(),
  // // 3mm Green
  // StylePtr<Layers<
  //   Black,
  //   TransitionLoopL<TrConcat<TrDelay<200>,White,TrDelay<200>,Black,TrDelay<100>>>,
  //   InOutTrL<TrInstant,TrInstant,Blinking<Black,White,1500,500>>>>(),
  StylePtr<InOutHelper<Blinking<Black,White,1500,500>, 1, 1, Sequence<White, Black, 90, 30, 0b1111110,0b0000000000000000>>>(),
  StylePtr<InOutHelper<Blinking<Black,White,1500,500>, 1, 1, Sequence<White, Black, 90, 30, 0b0011110,0b0000000000000000>>>(),
  StylePtr<InOutHelper<Blinking<Black,White,1500,500>, 1, 1, Sequence<White, Black, 90, 30, 0b0000110,0b0000000000000000>>>(),
  "ezra" 
}
};
...
{ 0, // blade ID resistor not used
  ...
  SimpleBladePtr<CreeXPE2WhiteTemplate<100>, NoLED, NoLED, NoLED, bladePowerPin4, -1, -1, -1>(),
  // 3mm YellowGreen LED Data NA Power 5
  SimpleBladePtr<CreeXPE2WhiteTemplate<100>, NoLED, NoLED, NoLED, bladePowerPin5, -1, -1, -1>(),
  // 3mm Green LED Data NA Power 6
  SimpleBladePtr<CreeXPE2WhiteTemplate<100>, NoLED, NoLED, NoLED, bladePowerPin6, -1, -1, -1>(),
CONFIGARRAY(presets) }
};
#endif
