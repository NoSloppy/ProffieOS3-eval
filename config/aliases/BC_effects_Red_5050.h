// Main Blade effects package Red (or dark) blades
...
// Lockup 2 - BC custom range mid-blade - Red or Yellow blade alt colors
    ...
    LockupTrL<Layers<
      ...
      TrConcat<TrInstant,AlphaL<Blinking<Rgb<100,200,255>,Strobe<BrownNoiseFlicker<Orange,Black,500>,Black,15,30>,60,500>,   Bump<Scale<BladeAngle<5000,28000>,Scale<BladeAngle<8000,16000>,Int<3000>,Int<44000>>,Int<3000>>,Scale<SlowNoise<Int<3000>>,Int<25000>,Int<32000>>>>,TrFade<500>>,
...
// Lightning Block Non-Responsive    
    LockupTrL<AlphaL<RandomFlicker<Strobe<Rgb<100,200,255>,Rgb<60,0,255>,50,10>,BrownNoiseFlicker<Rgb<60,0,255>,Black,500>>,LayerFunctions<
