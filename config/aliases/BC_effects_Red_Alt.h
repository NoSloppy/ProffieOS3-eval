...
AlphaL<Layers<
  ...
  // Blast v1
    TransitionEffectL<TrConcat<
        ...
        // Waves
        BlastL<TransitionEffect<Blue,White,TrInstant,TrWipe<150>,EFFECT_BLAST>,800,250,351>,
...
IsLessThan<BladeAngle<>,Int<16384>>>, // Only show on blade that's pointing up
  // Force Choke
