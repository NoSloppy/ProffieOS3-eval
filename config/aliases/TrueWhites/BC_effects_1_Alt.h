// SECOND Blade effects package for non-red blades of staff configuration

using BC_effects_1_Alt =
Layers<
...
IsLessThan<BladeAngle<>,Int<16384>>>,  // Only show when this SECOND blade is pointing up
...
IsGreaterThan<BladeAngle<>,Int<16384>>>,  // Only show when this SECOND blade is pointing down
//-------------------------------------------------------------------------------
  ...
  // Lightning Block - Non-responsive. BC custom color (purple hint w/ random strobe flashes because....lightning)
    ...
    //     AlphaL<RandomFlicker<Strobe<White,Rgb<83,0,255>,50,10>,BrownNoiseFlicker<Rgb<83,0,255>,Black,500>>,
    //     LayerFunctions<
