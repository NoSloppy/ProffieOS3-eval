...
using BC_effects_1_BlastRotate =
Layers<

  // Force effect powerup. WavLen duration sync.
  EffectSequence<EFFECT_FORCE,
    TransitionEffectL<TrConcat<TrSmoothFadeX<Percentage<WavLen<>,20>>,Strobe<Black,Rgb<0,0,80>,30,30>,TrFadeX<Percentage<WavLen<>,60>>,StaticFire<Blue,Strobe<Black,Cyan,30,30>,0,3,300>,TrFadeX<Percentage<WavLen<>,20>>>,EFFECT_FORCE>,
    TransitionEffectL<TrConcat<TrSmoothFadeX<Percentage<WavLen<>,20>>,Strobe<Black,Rgb<0,80,0>,30,30>,TrFadeX<Percentage<WavLen<>,60>>,StaticFire<Green,Strobe<Black,GreenYellow,30,30>,0,3,300>,TrFadeX<Percentage<WavLen<>,20>>>,EFFECT_FORCE>>,
  ...
  // Clash 1 - BladeAngle responsive.  Flash at impact, WavLen duration sync.
    // TransitionEffectL<TrConcat<TrInstant,GreenYellow,TrDelay<25>,AlphaL<TransitionEffect<BrownNoiseFlicker<Rgb<255,150,0>,Black,50>,White,TrInstant,TrFadeX<Percentage<WavLen<EFFECT_CLASH>,35>>,EFFECT_CLASH>,Bump<Scale<BladeAngle<>,Int<25000>,Int<8000>>,Int<18000>>>,TrFadeX<Percentage<WavLen<>,65>>>,EFFECT_CLASH>,
  ...
  // Blast - Blaster reflect cycles through different responsive effects
