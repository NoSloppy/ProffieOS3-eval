// MAIN Blade effects package for non-red blades of staff configuration

using BC_effects_1_Main =
Layers<

//-------------------------------------------------------------------------------
AlphaL<Layers< // Only show this Alpha Layer group of effects on staff blade that's pointing up.
  // Clash 1 - BladeAngle responsive. Yellowish impact. WavLen duration sync.
...
IsGreaterThan<BladeAngle<>,Int<16384>>>,  // Only show when this MAIN blade is pointing up
...
IsLessThan<BladeAngle<>,Int<16384>>>,  // Only show when this MAIN blade is pointing down
//-------------------------------------------------------------------------------
