...
BladeConfig blades[] = {
	{ 0,
	    ...
	    SubBladeWithList
	     ...
	     // Row 9 (left-to-right)
	     64, 65, 66, 67, 68>
	     (WS281XBladePtr<70, bladePin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3> >() ), /* Test List */
//		SubBlade (0, 4, NULL), /* emitter inner ring 8px */
//	    SubBladeWithStride (1, 15, 2, NULL), /* emitter outer ring 8px */

/*		SubBladeWithList <16, 17, 18, 19, 20, 
 	     // Row 2 (right-to-left)
