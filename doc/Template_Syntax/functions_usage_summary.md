...
Here’s a summary list of all of the "Usage:" comment sections from the header files in functions.

For example, if you were looking for what arguments BlastFadeoutF<> takes,  
now you’d know that it takes BlastFadeoutF<FADEOUT_MS, EFFECT>.  
...
## [BlasterModeF](https://github.com/profezzorn/ProffieOS/blob/master/functions/blaster_mode.h)
Usage: BlasterModeF
...
## [Bump, HumpFlickerFX, HumpFlickerF](https://github.com/profezzorn/ProffieOS/blob/master/functions/bump.h)
...
## [Remap](https://github.com/profezzorn/ProffieOS/blob/master/functions/center_dist.h)
...
## [ClampF](https://github.com/profezzorn/ProffieOS/blob/master/functions/clamp.h)
...
## [IntSelect, IntSelectX](https://github.com/profezzorn/ProffieOS/blob/master/functions/int_select.h)
...
## [ReadPinF, ReadPinF, AnalogReadPinF, AnalogReadPinF](https://github.com/profezzorn/ProffieOS/blob/master/functions/readpin.h)
Usage: ReadPinF<PIN>
...
## [SliceF, SliceF](https://github.com/profezzorn/ProffieOS/blob/master/functions/slice.h)
...
## [SwingSpeed, SwingAcceleration](https://github.com/profezzorn/ProffieOS/blob/master/functions/swing_speed.h)
