...
//0 Button
//make sure you have the following in your top config
//#define SA22C_TWIST_OFF
//#define SA22C_THRUST_ON
//#define SA22C_TWIST_ON
//#define MOTION_TIMEOUT 60 * 12000 * 1000
//#define SA22C_STAB_ON


// Activate Muted - none
// Activate - thurst while point up for normal activation, thurst while pointing down for fast activation
// Play/Stop Music - clash while saber is off and pointing up
// Turn off blade - point down and twist while ON 
// Next Preset - twist while OFF and point down
// Prev Preset - twist while OFF and point up
// Lockup - none
// Stab - thrust forward 
// Lightning Block - none
// Force - shake the saber up and down a bit while pointing up and saber on
// Melt - none
// Drag - none
// Blaster Blocks - point up twist while on
// Multi-Blast - none

// Color Change mode - shake the saber up and down a bit while pointing down and saber on, shake again to exit while pointing down
// Volume up - shake the saber up and down a bit while pointing up and saber off
// Volume down - shake the saber up and down a bit while pointing down and saber off
// Battery Level - stab while saber is off and pointing up
...
#define MOTION_TIMEOUT 60 * 3000 * 1000
#endif

#ifndef SA22C_SWING_ON_SPEED
#define SA22C_SWING_ON_SPEED 1000
#endif
...
if (millis() > 3000) {
  ...
  case EVENTID(BUTTON_NONE, EVENT_TWIST, MODE_OFF):
    // Delay twist events to prevent false trigger from over twistig
if (millis() - last_twist_ > 500 &&
...
// 0 button Force and Color Change mode
case EVENTID(BUTTON_NONE, EVENT_SHAKE, MODE_ON):
 if (fusor.angle1() < - M_PI / 4) {
      ToggleColorChangeMode();
return true;
